...
import DateRangePickerInputController from './DateRangePickerInputController.jsx';
import DayPickerRangeController from './DayPickerRangeController.jsx';
...
class DateRangePicker extends React.Component {
    ...
    maybeRenderDayPickerWithPortal() {
        ...
        if (withPortal || withFullScreenPortal || appendToBody) {
            return (
                <Portal
                    node={document && document.querySelector(parentElement)}>
    ...
    renderDayPicker() {
        ...
        return (
            ...
            >
                ...
                <button
                    className="DateRangePicker_closeButton ahoyclub-close"
                    type="button"
                ...
                <button
                    onClick={applySearch}
                    aria-label={phrases.closeDatePicker}
                    className="DateRangePicker_applyButton"
                >
                    Apply
                </button>
            </div>
    ...
    render() {
        ...
        // const onOutsideClick = (!withPortal && !withFullScreenPortal && hideCalendarOnClick) ? this.onOutsideClick : () => { };
        const onOutsideClick = (!withPortal && !withFullScreenPortal && hideCalendarOnClick) ? this.onOutsideClick : () => { };
        // if (withPortal && !hideCalendarOnClick) {
